...
client = OpenAI(api_key=os.getenv("SWIFT_AGENT_API_KEY"))
...
assistant = client.beta.assistants.create(
    ...
    instructions=(
        ...
        "anything related to the Swift coding language, all syntax and guidance you'll need is located in swift_guide.txt."
    ),
